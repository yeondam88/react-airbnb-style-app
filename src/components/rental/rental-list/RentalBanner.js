...
const RentalBanner = () => {
  return (
    ...
    <div className="row" style={{ flexDirection: 'column', marginBottom: '15px' }}>
      ...
      <img style={{ paddingLeft: '15px', paddingRight: '15px' }} src="https://a0.muscache.com/4ea/air/v2/pictures/e36e06a9-f9a4-49a5-a94c-02134a8787c5.jpg?t=c:w1131-h343,r:w1131-h343-sfit,e:fjpg-c75" />
    </div>
    </React.Fragment>
